...
export default function Cta() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div id="contact" className="w-full px-4 sm:px-0"> {/* Adjusted here */}
        <div className="bg-gradient-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            {/* Spotlight items */}
            <Spotlight className="group mx-auto flex justify-center items-center max-w-sm flex-wrap gap-6 lg:max-w-none lg:flex-nowrap" data-aos="fade-up">
              {/* Card 1 */}

      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            We are dedicated to providing top-notch IT solutions, programming expertise, and automation services.</p>
            <p className="text-lg text-indigo-200/65">
            ...
            We specialize in providing cutting-edge programming, automation, and DevOps services to help clients navigate the complexities of modern technology.</p>
            <p className="text-lg text-indigo-200/65">
            ...
            <p className="text-lg text-indigo-200/65">Our work is guided by core values that help us deliver the best solutions to our clients:
            </p>
          </div>
          {/* Spotlight items */}
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-gradient-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                  We are highly adaptable, shifting seamlessly between tools and technologies. This versatility lets us tackle diverse challenges and stay ahead in a fast-evolving industry.
                  </p>
                </div>
              </div>
            </a>

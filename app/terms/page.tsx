            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="prose prose-invert max-w-none">
                <div className="space-y-8 text-indigo-200/80">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-4">2. Services Provided</h2>
                    <p className="mb-4">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-4">3. Use License</h2>
                    <p className="mb-4">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-4">4. Client Obligations</h2>
                    <p className="mb-4">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-4">5. Payment Terms</h2>
                    <p className="mb-4">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-4">6. Intellectual Property</h2>
                    <p className="mb-4">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-4">7. Confidentiality</h2>
                    <p className="mb-4">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-4">8. Privacy Policy</h2>
                    <p className="mb-4">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-4">9. Modifications to Terms</h2>
                    <p className="mb-4">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-4">11. Contact Information</h2>
                    <p className="mb-4">
